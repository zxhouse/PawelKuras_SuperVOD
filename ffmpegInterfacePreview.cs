...
namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ffmpegProcess.StartInfo.Arguments = "-i uploads/" + token + " -vf subtitles=subtitles/" + token + " -ss 00:00:00 -to 00:00:30  previews/" + token + ".mp4";
            ffmpegProcess.Start();
            ...
            {
				File.Delete("C:\\xampp\\htdocs\\previews\\" + token + ".mp4");
